  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-slate-50 to-blue-50/20 dark:from-slate-950 dark:to-slate-950 p-4 font-sans text-slate-800 dark:text-slate-200 relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 z-20">
        ...
        >
          <svg className="h-4.5 w-4.5 text-blue-505 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-slate-200/80 dark:border-slate-850 bg-white/90 dark:bg-slate-900/40 p-8 shadow-xl dark:shadow-2xl backdrop-blur-xl animate-fadeIn">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {formData.role === "student" && (
            <div className="grid grid-cols-2 gap-4 border-t border-slate-200 dark:border-slate-800/60 pt-4 animate-fadeIn">
              <div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full mt-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-500 hover:to-indigo-400 py-3 text-xs font-bold tracking-wide text-white transition-all shadow-md active:scale-[0.98] disabled:opacity-50 cursor-pointer"
          >
            {loading ? (
